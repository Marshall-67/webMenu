...
function updateConfig() {
    const config = {
        ...
        skeletonColor: {
            r: parseInt(jscolor.presets.default.toHEXString(document.getElementById('skeletonColor').jscolor).slice(0, 2), 16),
            g: parseInt(jscolor.presets.default.toHEXString(document.getElementById('skeletonColor').jscolor).slice(2, 4), 16),
            b: parseInt(jscolor.presets.default.toHEXString(document.getElementById('skeletonColor').jscolor).slice(4, 6), 16),
        },
        ...
        crosshairColor: {
            r: parseInt(jscolor.presets.default.toHEXString(document.getElementById('crosshairColor').jscolor).slice(0, 2), 16),
            g: parseInt(jscolor.presets.default.toHEXString(document.getElementById('crosshairColor').jscolor).slice(2, 4), 16),
            b: parseInt(jscolor.presets.default.toHEXString(document.getElementById('crosshairColor').jscolor).slice(4, 6), 16),
        },
